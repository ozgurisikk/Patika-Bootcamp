...
public class CarManager {
    ...
    public boolean update(Car car) {
        if (this.getById(car.getId()) == null) {
            Helper.showMsg(car.getId() + " ID kayitli arac yok");
            return false;
        }
    ...
    public boolean delete(int id) {
        if (this.getById(id) == null) {
            Helper.showMsg(id + " ID kayitli arac yok");
            return false;
        }
    ...
    public ArrayList<Car> searchForBooking(String strt_date, String fnsh_date, Model.Type type, Model.Gear gear, Model.Fuel fuel) {
        ...
        //out date format = 2023-10-10 Y-m-d buna donusturuyoruz yani
        ...
        bookOrWhere.add("(book_fnsh_date BETWEEN '" + fnsh_date + "' AND '" + fnsh_date + "')");
    ...
    public List<Car> findPlateList(){
        return this.carDao.findPlateList();
    }
